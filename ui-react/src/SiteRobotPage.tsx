 ...
 */
const MELIS_KEY = 'site_robot_tool_display'   // rendable zone (forward ToolSiteRobot/tool-container)
const FRAME_ID = 'melis-brick-frame-siterobot'
...
export default function SiteRobotPage() {
