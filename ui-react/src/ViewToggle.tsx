...
// icônes et masque les libellés « New »/« Old » — utilisé sur viewport étroit, où le toggle complet
// pousse la ligne d'en-tête hors écran. Le toggle n'est JAMAIS retiré, juste rétréci.
