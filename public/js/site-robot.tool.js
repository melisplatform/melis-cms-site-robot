$(document).ready(function() {
    ...
    var zoneId   = "id_site_robot_tool_modal_content";
    // the melisKey of the modal content in the app.interface
    var melisKey = "site_robot_tool_modal_content";
    // the URL of the modal container
    var modalUrl = "/melis/MelisCmsSiteRobot/ToolSiteRobot/toolModalContainer";
